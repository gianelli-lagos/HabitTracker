...
def lambda_handler(event, context):
    ...
    If habit was NOT logged yesterday, resets streak to 0
    ...
    try:
        ...
        for habit in habits:
            ...
            if not logged_yesterday:
                # User didn't log yesterday - reset streak
                ...
                create_notification(
                    ...
                    type='streak_broken',
                    title='Streak Reset 😔',
                    message=f'Your {habit.name} streak was reset because you didn\'t log yesterday.',
                    data={
                        'habit_id': habit.id,
